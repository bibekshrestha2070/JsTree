        ...
        <div class="col-md-12">
            <div class="main-card mb-3 card">
                <div class="card-body">
                    ...
                    {!!Form::model($user,array('route'=>['update.user',$user->id],'class' => 'form-horizontal form-left'))!!}

                    @include('User::form')
                    <input class="mt-1 btn btn-primary btn-submit" type="submit" value="Update">
                    {!!Form::close()!!}
                </div>
            </div>
        </div>
            ...
            if (doing == false) {
                ...
                $.ajax({
                    ...
                    .always(function () {
                        ...
                        form.find('.btn-submit').val('Update');
                    });
            }
